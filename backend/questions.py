  ...
  "QUESTIONS": [
    {
      ...
      "prompt": "Extract the data from the input and determine whether the researcher is a cofounder in a company outside of BCH. Output Yes or No. If not mentioned, return NA."
    },
    {
      "id": 2,
    ...
    },
    {
      ...
      "prompt": "Extract the data from the input and identify the annual cash compensation. Apply de minimis threshold logic from HMS_COI_Policy: Income ≤ $25,000 annually. Return only numeric value or range. If explicitly none, return 0. If not mentioned, return NA. Refer to HMS_COI_Policy rules for guidance."
    },
    {
      "id": 6,
      "text": "How much time/effort does the researcher spend working for the company?",
      "prompt": "Extract the data from the input and identify time or effort spent working for the company (hours/week or % effort). Return only numeric value. If not mentioned, return NA."
    },
    {
      "id": 7,
    ...
    },
    {
      ...
      "prompt": "Extract the data from the input and determine if BCH receives any equity ownership percentage, cash payments, milestones, or royalties. Return the specific Equity % and/or Cash Amount/Type (e.g., '5% Equity', '$100k Milestone', 'Royalties on Net Sales'). If multiple, return values comma-separated. If explicitly 'None' or not mentioned, return NA."
    },
    {
      "id": 9,
      "text": "Does the researcher have any grants or research projects that relate to the company?",
      "prompt": "Extract the data from the input and identify any related grants or research projects. If multiple, return Ans1,Ans2. If not mentioned, return NA."
    },
    {
      "id": 10,
    ...
    },
    {
      ...
      "prompt": "Extract the data from the input. Output ONLY one value: HMS_COI_Policy or PHS_COI_Policy. Use PHS_COI_Policy only if PHS-funded research AND equity in a privately held company related to that research are explicitly stated. Otherwise output HMS_COI_Policy. If unclear, return NA. Refer to the provided COI rules to find the answer; do not hallucinate."
    },
    {
      "id": 14,
      "text": "What COI rule applies to this management plan?",
      "prompt": "Extract the data from the input and identify the applicable rule from the provided REFERENCE POLICIES. Return the exact value of the 'Name' field from the matching rule object (e.g., 'Clinical Research Rule (formerly the “1(a) Rule”)' or 'PHS FCOIRule'). Do NOT return the ID (like A1, A2). If multiple rules apply, return Name1,Name2. If none apply, return NA."
    },
    {
      "id": 15,
      "text": "Is the researcher petitioning for an exemption from a COI rule?",
      "prompt": "Extract the data from the input and determine whether the researcher is petitioning for an exemption. Output Yes or No. If not mentioned, return NA. Refer to the provided COI rules to find the answer; do not hallucinate."
    }
  ],
  "HMS_COI_Policy": {
    "Rules": [
      {
        ...
        "Actions": [
          "Faculty must be free of Financial Interests above de minimis thresholds before commencing Research",
      ...
      },
      {
        ...
        "Actions": [
          "Faculty cannot receive Sponsored Research support unless approved by Standing Committee",
          "Participation continues through entire Sponsored Research",
      ...
      },
      {
        ...
        "Actions": [
          "Faculty must not accept gifts, meals, or related fees"
        ],
        "Exceptions": [
